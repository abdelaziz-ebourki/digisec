      ...
      <section className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-20 md:grid-cols-2">
        <div className="relative">
          <img
            ...
            loading="lazy"
          />
          <div aria-hidden className="from-primary/30 absolute inset-0 rounded-2xl bg-gradient-to-tr to-transparent" />
        </div>
        <div>
      ...
      <section className="mx-auto grid max-w-6xl items-center gap-10 px-4 pb-20 md:grid-cols-2">
        ...
        <div className="relative order-1 md:order-2">
          <img
            ...
            loading="lazy"
          />
          <div aria-hidden className="from-primary/30 absolute inset-0 rounded-2xl bg-gradient-to-tl to-transparent" />
        </div>
      </section>
